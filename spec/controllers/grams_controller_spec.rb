...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#update action" do
    it "shouldn't allow users who didn't create the gram to update the gram" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#destroy action" do
    it "shouldn't allow someone other than the user who created the gram to destroy it" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
    ...
    it "shouldn't let unauthenticed users destroy a gram" do
      gram = FactoryBot.create(:gram)
      delete :destroy, params: { id: gram.id }
      expect(response).to redirect_to new_user_session_path
    end
